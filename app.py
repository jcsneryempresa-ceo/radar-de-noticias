...
def extrair_data_entry(entry):
    # RSS: published_parsed / updated_parsed (UTC) -> converte para BRT
...
with tabs[0]:
    ...
    assunto_livre = st.text_input("Assunto", placeholder="Ex: picolés, dengue, emprego… (se usar Editorial, pode deixar em branco)")
